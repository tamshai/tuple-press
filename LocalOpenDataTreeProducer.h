...
public :
   ...
   */
   ...
   LocalOpenDataTreeProducer(TTree *tree_ak4 = 0, TTree *tree_ak7 = 0, TH1F* trgNames = 0);
...
LocalOpenDataTreeProducer::LocalOpenDataTreeProducer(TTree *tree_ak4, TTree *tree_ak7, TH1F* trgNames) : fChain_ak4(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   TriggerNames = trgNames;
...
*/
   ...
   fChain_ak4->SetBranchAddress("PFJets_.CSV_", PFJets__CSV_, &b_PFJets__CSV_);
   
   fChain_ak4->SetBranchAddress("PFJets_.partonFlavour_", PFJets__partonFlavour_, &b_PFJets__partonFlavour_);
   fChain_ak4->SetBranchAddress("PFJets_.hadronFlavour_", PFJets__hadronFlavour_, &b_PFJets__hadronFlavour_);
